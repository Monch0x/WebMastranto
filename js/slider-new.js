 ...
 * 
 * 
 *       OJO para cambiar la velocidad de transicion esta en la linea 1791 y es ---> s.params.cssMode || (s.wrapperEl.style.transitionDuration = `${2000}ms`)
 * 
 * 
 */
    ...
    const K = {
        ...
        transition: {
            setTransition: function(e, t) {
                const s = this;
                s.params.cssMode || (s.wrapperEl.style.transitionDuration = `${e}ms`), // Esto estaba en s.wrapperEl.style.transitionDuration =  `${e}ms`
